@extends('layouts.error', ['title' => $code ?? 'Error'])
...
<div class="col-md-5 col-lg-4 mx-auto py-5">
    <div class="card border-0 shadow-lg p-4 rounded-4 text-center">
        <div class="card-body">
            ...
            <h2 class="fw-bold text-dark mb-2">{{ $code ?? 'Error' }}</h2>
            <h4 class="fw-semibold text-dark mb-3">@yield('title')</h4>
            <p class="text-muted fs-13 mb-4">@yield('message')</p>
