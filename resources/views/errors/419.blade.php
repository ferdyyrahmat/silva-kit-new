@extends('layouts.error', ['title' => '419 - Page Expired'])
        ...
        <div class="card-body">
            ...
            <div class="my-4">
                <span class="avatar-title bg-warning-subtle text-warning rounded-circle mx-auto d-flex align-items-center justify-content-center" style="width: 100px; height: 100px;">
                    <i class="mdi mdi-clock-alert-outline display-3"></i>
                </span>
            </div>

            <h2 class="fw-bold text-dark mb-2">419</h2>
            <h4 class="fw-semibold text-dark mb-3">Page Expired</h4>
            <p class="text-muted fs-13 mb-4">Your session has expired due to inactivity. Please refresh the page and try again.</p>
