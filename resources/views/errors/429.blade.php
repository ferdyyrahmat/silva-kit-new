@extends('layouts.error', ['title' => '429 - Too Many Requests'])
        ...
        <div class="card-body">
            ...
            <div class="my-4">
                <span class="avatar-title bg-danger-subtle text-danger rounded-circle mx-auto d-flex align-items-center justify-content-center" style="width: 100px; height: 100px;">
                    <i class="mdi mdi-speedometer-slow display-3"></i>
                </span>
            </div>

            <h2 class="fw-bold text-dark mb-2">429</h2>
            <h4 class="fw-semibold text-dark mb-3">Too Many Requests</h4>
            <p class="text-muted fs-13 mb-4">You have sent too many requests in a short amount of time. Please wait a minute before trying again.</p>
