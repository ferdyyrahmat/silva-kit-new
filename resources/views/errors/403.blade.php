@extends('layouts.error', ['title' => '403 - Forbidden Access'])
        ...
        <div class="card-body">
            ...
            <div class="my-4">
                <span class="avatar-title bg-warning-subtle text-warning rounded-circle mx-auto d-flex align-items-center justify-content-center" style="width: 100px; height: 100px;">
                    <i class="mdi mdi-lock-alert-outline display-3"></i>
                </span>
            </div>

            <h2 class="fw-bold text-dark mb-2">403</h2>
            <h4 class="fw-semibold text-dark mb-3">Access Forbidden</h4>
            <p class="text-muted fs-13 mb-4">You do not have the required permissions to access this page or resource. Please contact your system administrator if you believe this is an error.</p>
